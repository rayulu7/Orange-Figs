...
export const Testimonials = () => {
    ...
    return (
        ...
        >
            ...
            <div className="absolute top-0 left-0 w-[500px] h-[500px] rounded-full bg-white/5 blur-[120px] pointer-events-none" />
            <div className="absolute bottom-[-10%] right-[-10%] w-[400px] h-[400px] rounded-full bg-amber-300/10 blur-[100px] pointer-events-none" />
            ...
            <div className="container-custom relative z-10 w-full flex flex-col h-full">
                ...
                >
                    {testimonials.map((t, i) => (
                        ...
                        >
                            <div className="h-full bg-white/10 backdrop-blur-md border border-white/20 rounded-[2rem] p-8 flex flex-col gap-6 relative group hover:bg-white/15 transition-all duration-500">

...
export const RegistrationPopup = () => {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            <DialogContent hideClose className="sm:max-w-[850px] p-0 overflow-hidden border-[4px] border-orange-400 rounded-[3.5rem] bg-white shadow-2xl flex flex-col md:flex-row h-[500px]">
                {/* Left side: Image */}
                ...
                <div className="w-full md:w-1/2 p-10 flex flex-col justify-center text-center relative">
                    <DialogClose className="absolute right-6 top-6 w-10 h-10 rounded-full bg-orange-50 flex items-center justify-center text-orange-500 hover:bg-orange-100 transition-colors">
                        <X size={20} />
                    </DialogClose>
                    ...
                    <div className="space-y-8 max-w-[320px] mx-auto">
                        <div className="flex flex-col items-center gap-4">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-xl font-black italic tracking-tighter text-orange-500 font-serif">
                                    OrangeFigs
                                </span>
                            </div>
